...
Namespace DataTypeNode
    ...
    Friend Class SampleNodeManager
        ...
        Protected Overrides Function CreateNodes(references As OpcNodeReferenceCollection) As IEnumerable(Of IOpcNode)
            ...
            Dim status As New OpcDataVariableNode(Of MachineStatus)(machineOne, "Status", MachineStatus.Started)
            ...
            Return New IOpcNode() {machineOne, New OpcDataTypeNode(Of MachineStatus)()}
        End Function
    End Class
End Namespace
