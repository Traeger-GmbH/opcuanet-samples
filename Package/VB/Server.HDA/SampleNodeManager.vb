...
Namespace HDA
    ...
    Friend Class SampleNodeManager
        ...
        ''' </summary>
        Private positionHistorian As OpcNodeHistorian
        ...
        Protected Overrides Function CreateNodes(references As OpcNodeReferenceCollection) As IEnumerable(Of IOpcNode)
            ...
            Me.positionHistorian = New OpcNodeHistorian( _
                    Me, New OpcDataVariableNode(Of Integer)(machineOne, "Position", -1))

            SampleNodeManager.CreateHistoryEntries(Me.positionHistorian)
        ...
        ''' <returns></returns>
        Protected Overrides Function RetrieveNodeHistoryProvider(node As IOpcNode) As IOpcNodeHistoryProvider
            If Me.positionHistorian.Node Is node Then
                Return Me.positionHistorian
            End If
        ...
        Private Shared Sub CreateHistoryEntries(historian As OpcNodeHistorian)
            For second As Integer = 0 To 3599
                Dim value As New OpcHistoryValue( _
                        1000 + second, _
                        DateTime.UtcNow.Date.AddHours(6).AddSeconds(second))
